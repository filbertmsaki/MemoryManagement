...
public class MemoryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            listViewHolder.progressBar = (ProgressBar)convertView.findViewById(R.id.stats_progressbar);
        ...
        listViewHolder.progressBar.setProgress(listStorage.get(position).getProgressBar());
